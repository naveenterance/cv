    ...
    <>
      {page == 1 && (
        <div className=" h-full  lg:mx-96  mt-24  mb-12 lg:flex  font-mono">
          ...
          <div className="px-4   h-4 w-8 grid grid-cols-4 gap-16 lg:my-12 my-2 animate__animated animate__fadeInRight">
            <div className="  col-span-4 align-left">
              <p className="text-4xl font-bold  mr-4">Pokemon API</p>
              <p className="text-xl"> Fetches Pokemon stats and skills</p>
            </div>
            ...
            <div onClick={() => handleclick(3)} className="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div onClick={() => handleclick(2)} className="">
              ...
              <div className="relative  mx-auto lg:w-1/4 p-2 rounded-full ">
                <div className="flex  justify-center items-center">
                  <p className="text-xl italic font-bold opacity-35 ">
      ...
      {page == 2 && (
        <div className=" h-full  lg:mx-96  mt-24  mb-12 lg:flex  font-mono">
          ...
          <div className="px-4   h-4 w-8 grid grid-cols-4 gap-16 lg:my-12 my-2 animate__animated animate__fadeInRight">
            <div className="  col-span-4 align-left">
              <p className="text-4xl font-bold  mr-4">chAT aPP</p>
              <p className="text-xl"> Anonymous chat app</p>
            </div>
      ...
      {page == 3 && (
        <div className=" h-full  lg:mr-96  mt-24  mb-12 lg:flex  font-mono">
          <div class="relative lg:ml-56 border-gray-800   border-[16px] rounded-t-xl rounded-b-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px] animate__animated animate__fadeInLeft">
          ...
          <div className="px-4   h-4 w-8 grid grid-cols-4 gap-16 lg:my-12 my-2 animate__animated animate__fadeInRight">
            <div className="  col-span-4 align-left">
              <p className="text-4xl font-bold  mr-4">Learn React</p>
              <p className="text-xl">A study on react concepts</p>
            </div>
