...
const About = () => {
  return (
    <>
      <div class="flex flex-col items-center mx-auto mt-12  rounded-lg lg:w-1/2 shadow md:flex-row  hover:bg-gray-100 animate__animated animate__fadeInLeft">
        <img
      ...
      <div class="flex flex-col  items-center mx-auto mt-12  rounded-lg lg:w-1/2 shadow md:flex-row hover:bg-gray-100 animate__animated animate__fadeInRight">
